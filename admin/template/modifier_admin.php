								...
								<div class="panel-wrapper collapse in">
									<div class="panel-body">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-wrap">
													<form data-toggle="validator" role="form" method="POST" action="views/modifieradmin.php" enctype="multipart/form-data">
														<input type="hidden" name="xmail" value="<?php echo $_POST['email'] ?>">
														<div class="form-group">
															<label for="inputName" class="control-label mb-10">Name</label>
															<input name="nom" type="text" class="form-control" id="inputName" value="<?php echo $_POST['nom'] ?>" required>
														</div>
													
														<div class="form-group">
															<label for="inputEmail" class="control-label mb-10">Email</label>
															<input name="email" type="email" class="form-control" id="inputEmail" value="<?php echo $_POST['email'] ?>"data-error="Bruh, that email address is invalid" required>
														...
														<div class="form-group">
															...
															<input name="telephone" type="number" class="form-control" id="inputelephone" value="<?php echo $_POST['telephone'] ?>" required>
														</div>
														<div class="form-group">
