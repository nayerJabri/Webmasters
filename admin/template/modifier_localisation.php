							...
							<div class="panel-wrapper collapse in">
								<div class="panel-body">
									<div id="australia" style="height: 450px">
										<form action="views/modifier_localisation.php" onsubmit="return validateForm()" method="POST" id="map" >
											<div class="col-md-12">
												<input type="hidden" name="reference" value="<?php echo $_POST['reference'] ?>">
												<div class="form-group">															
													<label class="control-label mb-10">Description</label>
													<input type="text" name="description" id="desc" class="form-control" value="<?php echo $_POST['description'] ?>" >
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" name="lat" value="<?php echo $_POST['lat'] ?>" id="lat"  class="form-control"  readonly>
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" name="lng" value="<?php echo $_POST['lng'] ?>" id="lng" class="form-control" readonly id="referencee" >
												</div>
											</div>
											<div class="col-md-9">
												<div class="form-group">
    ...
    <script>
        ...
        L.tileLayer('https://tile.jawg.io/jawg-sunny/{z}/{x}/{y}.png?access-token=BKtmGRtY1OYcjzZSz7n1jKKVUdqLS4RhQWg7ZRgmTh1W6oGTrpbjLkjGgaS6Tej2', {
         ...
         var layerGroup = L.layerGroup().addTo(myMap);
           marker=["<?php echo $_POST['lat'] ?> ","<?php echo $_POST['lng'] ?> " ];
         L.marker(marker).addTo(layerGroup);
