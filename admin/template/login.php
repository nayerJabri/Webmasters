...
$msg="";
 if (isset($_POST['email'])) {
    ...
    include "config.php";
   $admin=new administrateurC();
   $user=$admin->afficheruser($_POST['email']);
   if($_POST['motdepasse']==$user['motdepasse'])
   {
       $x=$admin->livreur($_POST['email']);
       //var_dump($x);
       
       if (isset($x)) {
       		$_SESSION['admin']=$_POST['email'];
       		 header('Location: affichage_pour_livreur.php');
       		  exit();
       }
       else{
       	$_SESSION['admin']=$_POST['email'];
		...
		<div class="wrapper pa-0">
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="index.html">
						<img class="brand-img mr-10" src="../../assets/images/mt-logo.png" alt="brand"/>
 					</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign in to SoukElMedina</h3>
										...
										<div class="form-wrap">
											<form action="login.php" method="POST">
												...
												<div class="form-group">
													...
													<div class="clearfix"></div>
													<input type="password" name="motdepasse" class="form-control" required="" id="exampleInputpwd_2" placeholder="Enter pwd">
												</div>
