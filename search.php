...
if(isset($_GET['voice']) and isset($_POST['pos']) and isset($_POST['n'])) 
{
	 include_once "config.php"; 

include_once "core/produitC.php"; 
$produit=new produitC();
$liste=$produit->recherche($_GET['voice'],$_POST['pos'],$_POST['n']);
}
...
include_once "core/produitC.php"; 
$produit=new produitC();
$liste=$produit->recherche($_GET['voice'],0,5);
 }
?>
			<!-- mt main start here -->
			<main id="mt-main">
						...
						<div class="col-xs-12 col-sm-8 col-md-9 wow fadeInRight" data-wow-delay="0.4s">
							...
							<nav class="mt-pagination">
								<ul class="list-inline">
									<li><form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
										<input type="hidden" name="pos" value="0">
										<input type="hidden" name="n" value="5">
									<a onclick="$(this).closest('form').submit();return false;">1</a></form></li>
									<li><form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
										<input type="hidden" name="pos" value="5">
										<input type="hidden" name="n" value="5">
									<a onclick="$(this).closest('form').submit();return false;">2</a></form></li>
									<li><form action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
										<input type="hidden" name="pos" value="10">
										<input type="hidden" name="n" value="5">
									<a onclick="$(this).closest('form').submit();return false;">3</a></form></li>
